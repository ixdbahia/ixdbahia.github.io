...
// Pano2VR 5.2.2/15983
// Filename: interfazb360.ggsk
// Generated ju. abr. 16 13:26:18 2020
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._title__text.innerHTML="<b>Bah\xeda en 360\xba<\/b>";
		...
		this._description__text.innerHTML="Para recorrer la ciudad.";
		...
		this._author__text.innerHTML="By Tres Barbas";
		...
		this._copyright.ggUpdateText=function() {
			var hs="&#169; "+me.ggUserdata.copyright+" Tres Barbas";
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
